...
pending_entered:
discarded_entered:
resolved_entered: 2026-09-09T03:31:16+09:00
discard_reason:
pending_reason:
close_reason: ["done: v0.0.20 で M4 テストが実 op を呼ぶ形に変更、delivery テストは本物の classify() で判定 (commit dc8345eb)", "done: M3 一覧テストは既存で十分と判断"]
blocked_by:
