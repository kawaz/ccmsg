...
|---|---|---|---|---|
| 2026-09-18 | bug | open | [terminals-test-timeout-once-under-full-run](./2026-09-18-terminals-test-timeout-once-under-full-run.md) | 全体テストで 1 回だけ terminals.test.ts が 5004ms で timeout、原因未特定 (調査未完了) |
