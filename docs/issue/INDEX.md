...
|---|---|---|---|---|
| 2026-09-14 | bug | open | [inbox-replays-records-the-contract-cannot-state](./2026-09-14-inbox-replays-records-the-contract-cannot-state.md) | inbox が起動時に読み戻した保持レコードを契約で検証せず、人向け view の frame が webui で弾かれる |
