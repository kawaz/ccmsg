...
| 2026-09-14 | design | open | [harness-sessions-scan-stays-synchronous](./2026-09-14-harness-sessions-scan-stays-synchronous.md) | `sessions/harness.ts` の `scan()` (config home の `sessions/` の読み) が同期のまま残っている |
