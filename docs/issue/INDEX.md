...
|---|---|---|---|---|
| 2026-09-15 | bug | open | [auth-ws-test-port-collision](./2026-09-15-auth-ws-test-port-collision.md) | auth の WS テストが並行実行下でポート衝突して落ちる (`test/auth.test.ts` のランダム/固定基点採番) |
