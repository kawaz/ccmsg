...
| 2026-09-09 | bug | open | [session-status-fold-missing-fields](./2026-09-09-session-status-fold-missing-fields.md) | session_status の fold 処理が `api_error` と `last_user_input_at` しか埋... |
...
| 2026-09-09 | task | open | [kv-lww-and-tombstone](./2026-09-09-kv-lww-and-tombstone.md) | kv ストアの LWW (last-write-wins、`updated_at` 後勝ち) と delete 時の tomb... |
