...
|---|---|---|---|---|
| 2026-09-12 | bug | open | [dump-since-relative-and-invalid](./2026-09-12-dump-since-relative-and-invalid.md) | `ccmsg dump --since / --until` は ISO / epoch ms / record uuid だけを受け、`-10m` のような相… |
